...
int main(int nargs, char** argv)
{
	...
	theParameters.expectDouble("Dipolepos0");
	theParameters.expectDouble("Dipolepos1");
	theParameters.expectDouble("Dipolepos2");
	theParameters.expectDouble("Dipole0");
	theParameters.expectDouble("Dipole1");
	theParameters.expectDouble("Dipole2");
